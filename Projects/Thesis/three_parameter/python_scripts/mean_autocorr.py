...
print "Reading Data"
E2_data = h5_file['/zoidberg1/data/users/dhruvinj/three_parameter/mean_autocorr/E2']
E3_data= h5_file['/zoidberg1/data/users/dhruvinj/three_parameter/mean_autocorr/E3']
A3_data= h5_file['/zoidberg1/data/users/dhruvinj/three_parameter/mean_autocorr/A3']


E2_sub_data=E2_data[1000000:1800000]
E3_sub_data=E3_data[1000000:1800000]
A3_sub_data=A3_data[1000000:1800000]
...
A3_mean = np.zeros(A3_sub_data.size)
E3_mean = np.zeros(E3_sub_data.size)
E2_mean = np.zeros(E2_sub_data.size)

for i in xrange(A3_sub_data.size):
    A3_mean[i] = np.mean(A3_sub_data[0:i])
...
ax1.plot(A3_mean,linestyle='-',color='blue',lw=2,label=" A3 (cm^3/s/mol)")
ax1.plot(E3_mean,linestyle='-',color='red',lw=2,label= " E3 (KJ/mol)")
ax1.plot(E2_mean,linestyle='-',color='green',lw=2,label= " E2 (KJ/mol)")
...
print "DONE WITH MEAN - NEXT AutoCorrelation"

#Autocorrelation
E3_sub_data=E3_data[1000000:1001000]
A3_sub_data=A3_data[1000000:1001000]
...
gn = ax2.acorr(A3_sub_data-np.mean(A3_data), usevlines=False, maxlags=None, normed=True, lw=2, linestyle='-', marker='.', color='blue',label= " A3 ")

ax2.set_xbound(lower=0, upper=1000)
