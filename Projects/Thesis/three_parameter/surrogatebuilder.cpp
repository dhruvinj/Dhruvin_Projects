...
public:
                                 ...
                                 
  {
    ...
    */
    ...
    double param_3 = domainVector[2];			

    double flamespd =0; 

    int rank = this->m_data.get_dataset(0).get_paramDomain().env().worldRank();    

    _model.flamespeed(0,0,flamespd, param_1 ,param_2, param_3, rank, _count );
  ...
  */
...

  {
    ...
    */
    ...
    const std::vector<unsigned int> n_points(3,35);
    ...
    data_writer.write( "flamespeed_75.dat" , data.get_dataset(0) );
