      ...
      V * hessianEffect) const
  {
   ...
   double value_100 = _flame_surrogate_100->evaluate(domainVector);
    ...
    for (unsigned int i = 0; i < modelOutput.sizeLocal(); i++) {
      ...
      modelOutput[2] = value_40;
      modelOutput[3] = value_46;    
      modelOutput[4] = value_53;
      modelOutput[5] = value_75;
      modelOutput[6] = value_100;
      */
