...
print "Reading Data"
E2_data = h5_file['/zoidberg1/data/users/dhruvinj/multiple_data/mean_autocorr/E2']
E3_data= h5_file['/zoidberg1/data/users/dhruvinj/multiple_data/mean_autocorr/E3']

E2_sub_data = E2_data[800000:100000000:200]
E3_sub_data = E3_data[800000:100000000:200]
...
ax1.set_xlabel( " E2 [KJ/mol]", fontsize=axis_label_fontsize)
ax1.set_ylabel( "Output Samples", fontsize=axis_label_fontsize)

print "Plotting Histogram"
ax1.hist( E2_sub_data, bins=250, align='mid' )
...
x = linspace(-20, 50, 5000)

print "Plotting KDE"
#ax2.plot( x, density(x), 'k--', linewidth=1 )
ax2.plot(x, gaussian(E2_mean,E2_sigma,x), 'r-', linewidth=1 )

ax2.set_xbound(lower=-20, upper=50)
...
ax3.set_xlabel( " E3 [KJ/mol]", fontsize=axis_label_fontsize)
...
x = linspace(-30, 50, 5000)

print "Plotting KDE"
#ax2.plot( x, density(x), 'k--', linewidth=1 )
ax4.plot(x, gaussian(E3_mean,E3_sigma,x), 'r-', linewidth=1 )

ax4.set_xbound(lower=-30, upper=50)
