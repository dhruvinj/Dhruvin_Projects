...
void dissipation(int nodes, double** u, double** v, double** p, double** U, double** V, double** g_11, double** g_22, double** J, double** dis_1, double** dis_2, double** dis_3);
...
curvilinearrhs(x, y, nodes,eta, xita, G, J, xita_x, xita_y, eta_x,  eta_y,  x_xita,  y_eta, x_eta, y_xita,  uold,  vold,  pold, R_ca, R_cu,  R_cv,  U,  V,  g_11,  g_12,  g_22,  dEs1,dEs2, dEv1,dEv2);
...
for(int i = 1; i < nodes-1; i++)
{
	for(int j = 1; j < nodes-1; j++){
		...
		p1[i][j] = pold[i][j] + double(1/4)*delta_t*R_ca[i][j];
		u1[i][j] = uold[i][j] + double(1/4)*delta_t*R_cu[i][j];
		v1[i][j] = vold[i][j] + double(1/4)*delta_t*R_cv[i][j];
...
curvilinearrhs(x, y, nodes,eta, xita, G, J, xita_x, xita_y, eta_x,  eta_y,  x_xita,  y_eta, x_eta, y_xita,  u1,  v1,  p1, R_ca, R_cu,  R_cv,  U,  V,  g_11,  g_12,  g_22,  dEs1,dEs2, dEv1,dEv2);
...
for(int i = 1; i < nodes-1; i++)
{
	for(int j = 1; j < nodes-1; j++){
		...
		p2[i][j] = pold[i][j] + double(1/3) * delta_t * R_ca[i][j];
		u2[i][j] = uold[i][j] + double(1/3) * delta_t * R_cu[i][j];
		v2[i][j] = vold[i][j] + double(1/3) * delta_t * R_cv[i][j]; 
...
curvilinearrhs(x, y, nodes,eta, xita, G, J, xita_x, xita_y, eta_x,  eta_y,  x_xita,  y_eta, x_eta, y_xita,  u2,  v2,  p2, R_ca, R_cu,  R_cv,  U,  V,  g_11,  g_12,  g_22,  dEs1,dEs2, dEv1,dEv2);
...
for(int i = 1; i < nodes-1; i++)
{
	for(int j = 1; j < nodes-1; j++){
		...
		p3[i][j] = pold[i][j] + double(1/2) * delta_t * R_ca[i][j];
		u3[i][j] = uold[i][j] + double(1/2) * delta_t * R_cu[i][j];
		v3[i][j] = vold[i][j] + double(1/2) * delta_t * R_cv[i][j];
...
curvilinearrhs(x, y, nodes,eta, xita, G, J, xita_x, xita_y, eta_x,  eta_y,  x_xita,  y_eta, x_eta, y_xita,  u3,  v3,  p3, R_ca, R_cu,  R_cv,  U,  V,  g_11,  g_12,  g_22,  dEs1,dEs2, dEv1,dEv2);
dissipation(nodes, u3, v3,  p3, U, V, g_11, g_22, J,dis_1,dis_2,dis_3);

for(int i = 1; i < nodes-1; i++)
{
	for(int j = 1; j < nodes-1; j++){

		pnew[i][j] = pold[i][j] +  delta_t * (R_ca[i][j] -J[i][j]*dis_1[i][j]);
		unew[i][j] = uold[i][j] +  delta_t * (R_cu[i][j] -J[i][j]*dis_2[i][j]);
		vnew[i][j] = vold[i][j] +  delta_t * (R_cv[i][j] -J[i][j]*dis_3[i][j]);
